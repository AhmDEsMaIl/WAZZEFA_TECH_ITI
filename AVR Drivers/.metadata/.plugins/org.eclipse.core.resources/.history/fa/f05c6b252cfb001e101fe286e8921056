...
#define PORTA_PIN1_INITIAL_VALUE    INPUT_PULLUP
...
#define PORTC_PIN0_INITIAL_VALUE	OUTPUT_HIGH
#define PORTC_PIN1_INITIAL_VALUE    OUTPUT_HIGH
#define PORTC_PIN2_INITIAL_VALUE    OUTPUT_HIGH
#define PORTC_PIN3_INITIAL_VALUE    OUTPUT_HIGH
#define PORTC_PIN4_INITIAL_VALUE    OUTPUT_HIGH
#define PORTC_PIN5_INITIAL_VALUE    OUTPUT_HIGH
#define PORTC_PIN6_INITIAL_VALUE    OUTPUT_HIGH
#define PORTC_PIN7_INITIAL_VALUE	OUTPUT_HIGH
