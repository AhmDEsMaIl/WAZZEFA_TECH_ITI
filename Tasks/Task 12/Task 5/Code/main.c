...
int main (void)
{
	...
	MGPIO_voidSetPinMode(GPIO_PORTA,GPIO_PIN9,GPIO_INPUT);
	MGPIO_voidSetPinInputMode(GPIO_PORTA,GPIO_PIN9,GPIO_PULLUP);
	/******************** APP ************/
	...
	while(1)
	{
		...
		MGPIO_voidGetPinValue(GPIO_PORTA,GPIO_PIN9,&value);
		if(value==GPIO_PIN_LOW)
		{
			c--;
			while(value==GPIO_PIN_LOW)
